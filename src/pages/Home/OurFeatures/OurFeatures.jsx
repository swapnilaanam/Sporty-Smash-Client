...
const OurFeatures = () => {
    return (
        <div className="pt-28 pb-36 md:pb-0 min-h-[750px]" id="feature">
            <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-evenly gap-10 px-4">
                <div className="h-[250px] md:h-full relative w-full md:w-3/5">
                ...
                <div className="w-full flex flex-col items-center md:w-2/5 text-center">
                    <div>
                    ...
                    <div className="space-y-7 my-20">
                        <div className="flex justify-start items-center gap-3 md:gap-8">
                            <div>
                                <img src={sportsFeatureIcon} alt="sports feature icon" className="w-20 h-20" />
                            </div>
                            <h4 className="text-lg font-medium leading-tight">Different Sports Categories</h4>
                        </div>
                        <div className="flex justify-start items-center gap-3 md:gap-8">
                            <div>
                                <img src={oneToOneIcon} alt="sports feature icon" className="w-20 h-20" />
                            </div>
                            <h4 className="text-lg font-medium">One To One Sessions</h4>
                        </div>
                        <div className="flex justify-start items-center gap-3 md:gap-8">
                            <div>
                                <img src={paymentMethodsIcon} alt="sports feature icon" className="w-20 h-20" />
                            </div>
                            <h4 className="text-lg font-medium">Easy Payment Methods</h4>
                        </div>
                        <div className="flex justify-start items-center gap-3 md:gap-8">
                            <div>
                                <img src={instructorsIcon} alt="sports feature icon" className="w-20 h-20" />
                            </div>
